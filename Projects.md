...
*   **ETL and Data Ingestion:** Supported the development of an ETL tool that validates and ingests destination data from spreadsheets and CSVs, handling slug generation, geocoding, and image parsing, helping process over 7,500 place records into the production database.
