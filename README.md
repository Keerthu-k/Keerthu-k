...
I’m also exploring modern frontend development to better understand the full lifecycle of building and shipping software.
...
`REST APIs`  `Microservices`  `React`  `Next.js`  
`Git`  `Docker`  `Agile`
