...
| Production backend engineering | Python/FastAPI services supporting three live applications at YUVABE, including one B2B product with 500+ daily active business users | Demonstrates production-scale backend engineering. |
